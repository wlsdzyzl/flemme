...
from flemme.color_table import scannet_color_table, custom_color_table, rainbow_rgb
...
if __name__ == "__main__":
    ### rainbow bar
    cv = np.linspace(0, 1.0, 100)
    rainbow_tables = np.array([rainbow_rgb(c) for c in cv])
    
    draw_combined_color_bars(
        color_tables=[scannet_color_table, custom_color_table, rainbow_tables],
        titles=["ScanNet Color Table", "Custom Color Table", 'Rainbow Color Table'],
        figsize=(14, 3),
